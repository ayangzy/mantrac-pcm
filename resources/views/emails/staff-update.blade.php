...
<head>
    ...
    <title>Staff Profile Update Notification</title>
...
<body style="
        ...
        ">
    <div style="display: none">Important: Updates to Your Profile</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="
                                            ...
                                            <p style="margin: 24px 0">
                                                We hope this message finds you well. We wanted to inform you that some updates have been made to your profile by the administration. These changes were made to ensure that your information is accurate and up to date.

                                                Please take a moment to review your profile and verify that all the details reflect your current information. If you notice any discrepancies or have any questions, please don't hesitate to reach out to the administration or your supervisor.

                                                We value your cooperation and understanding in keeping your profile updated. Thank you for your attention to this matter.
                                            </p>
                                            <table style="
                                                        font-family: 'Montserrat',
                                                            Arial, sans-serif;
                                            ...
                                            <p style="margin: 0 0 16px">
                                                Best Regards, <br />The
                                                <b>{{ $user->staff->organisation->organisation_name}}</b>
                                                Team
                                            </p>
                                        </td>
                                    </tr>
