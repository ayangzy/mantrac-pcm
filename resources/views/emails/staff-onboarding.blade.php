...
<body style="
        ...
        ">
    <div style="display: none">Welcome to {{$user->staff->organisation->organisation_name}} - Complete Your Onboarding and Set Up Your Profile</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="
                                            ...
                                            <p style="margin: 24px 0">
                                                ...
                                                as a part of our team and
                                                excited to embark on this
                                                journey together towards
                                                excellence in digital
                                                transformation and software
                                                solutions. At
                                                <b>{{ $user->staff->organisation->organisation_name}}</b>, we believe in providing
                                                innovative software
                                                solutions that exceed
                                                expectations, and we are
                                                thrilled to have you on
                                                board to contribute to our
                                                vision. To complete your
                                                onboarding and set up your
                                                profile, please click on the
                                                following link: <b><a href="{{ $resetLink }}">Set Password</a></b> Once
                                                you access the platform, you
                                                ...
                                                and functionalities
                                                available to you. Once
                                                again, we extend our warmest
                                                welcome to <b>{{ $user->staff->organisation->organisation_name}}</b>
                                                We look forward to
                                                witnessing your
                                                contributions and
                                                achievements as we work
                                                together to be a pacesetter
                                                in digital transformation
                                                and software solutions in
                                                West Africa by 2025. Best
                                                regards,
                                            </p>
                                            <table style="
                                                        font-family: 'Montserrat',
